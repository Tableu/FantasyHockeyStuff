...
(
    ...
    PlayerID              BIGINT NOT NULL,
    TeamID                INT NULL,
    -- DECIMAL, not INT/SMALLINT -- Apples & Ginos, Dailyfaceoff, and Fantrax ("Dom") all
    -- genuinely project these to fractional precision (e.g. 50.4 goals, 83.2625 GP), not
    -- whole counts; only DtZ and Lineup Experts happen to publish whole numbers. INT here
    -- used to silently round every source's fractional projection down to its nearest
    -- integer at import time, before it ever reached the blending sheet.
    GamesPlayed           DECIMAL(5,2) NULL,
    Goals                 DECIMAL(6,2) NULL,
    Assists               DECIMAL(6,2) NULL,
    Points                DECIMAL(6,2) NULL,
    PowerPlayPoints       DECIMAL(6,2) NULL,
    ShortHandedPoints     DECIMAL(6,2) NULL,
    Shots                 DECIMAL(6,2) NULL,
    Hits                  DECIMAL(6,2) NULL,
    Blocks                DECIMAL(6,2) NULL,
    PenaltyMinutes        DECIMAL(6,2) NULL,
    AverageTOIMinutes     DECIMAL(5,2) NULL,
    FaceoffWinPct         DECIMAL(5,4) NULL,
    PlusMinus             DECIMAL(6,2) NULL,
    PowerPlayGoals        DECIMAL(6,2) NULL,
    PowerPlayAssists      DECIMAL(6,2) NULL,
    FaceoffWins           DECIMAL(6,2) NULL,
    FaceoffLosses         DECIMAL(6,2) NULL,
    CreatedAt             DATETIME2(0) NOT NULL DEFAULT SYSUTCDATETIME(),
...
(
    ...
    PlayerID               BIGINT NOT NULL,
    TeamID                 INT NULL,
    -- See Projections.SkaterProjections' comment above -- Dailyfaceoff projects goalie
    -- Shutouts fractionally too (e.g. 1.1, 2.3), so these are DECIMAL for the same reason.
    GamesPlayed            DECIMAL(5,2) NULL,
    Wins                   DECIMAL(5,2) NULL,
    Losses                 DECIMAL(5,2) NULL,
    OvertimeLosses         DECIMAL(5,2) NULL,
    GoalsAgainstAverage    DECIMAL(5,3) NULL,
    SavePercentage         DECIMAL(6,4) NULL,
    Shutouts               DECIMAL(5,2) NULL,
    GamesStarted           DECIMAL(5,2) NULL,
    GoalsAgainst           DECIMAL(6,2) NULL,
    ShotsAgainst           DECIMAL(6,2) NULL,
    Saves                  DECIMAL(6,2) NULL,
    CreatedAt              DATETIME2(0) NOT NULL DEFAULT SYSUTCDATETIME(),
